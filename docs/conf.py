...
"""
course_enrollment_api documentation build configuration file.
...
html_context = {
    ...
    "github_repo": 'course_enrollment_api',  # Repo name
...
#
html_theme_options = {
    "repository_url": "https://github.com/openedx/course_enrollment_api",
...
#
# html_title = 'course_enrollment_api v0.1.0'
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'course_enrollment_api'),
                os.path.join(root_path, 'course_enrollment_api/migrations')])
